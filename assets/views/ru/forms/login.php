...
>
    ...
    <div class="form-group">
        <label class="mb-1 font-weight-bold" for="login-username">Логин</label>
        <input type="text" name="login[username]" value="<?= Request::postInput('login', 'username') ?: ''; ?>"
               id="login-username" class="form-control form-control-sm <?= $this->e('login-username') ? 'is-invalid' : ''; ?>" placeholder="Логин"
        >
    ...
    <div class="form-group">
        <label class="mb-1 font-weight-bold" for="login-password">Пароль</label>
        <input type="password" name="login[password]"
               id="login-password" class="form-control form-control-sm <?= $this->e('login-username') ? 'is-invalid' : ''; ?>" placeholder="Пароль"
        >
    ...
    <div class="row">
        <div class="col-12">
            <button id="login-submit" type="submit" class="btn btn-sm btn-primary px-3">Войти</button>
        </div>
    </div>
</form>